...
public class AUIRecorderView extends FrameLayout
    ...
    private com.aliyun.svideosdk.common.struct.recorder.CameraType mCameraType
            = com.aliyun.svideosdk.common.struct.recorder.CameraType.FRONT;
    private boolean mIsCameraFacingFront = true;
...
//        mVideoContainer.addView(container, layoutParams);
    ...
    private void initRecorder() {
        ...
        setCameraType(recorder.getCameraCount() == 1 ?
                com.aliyun.svideosdk.common.struct.recorder.CameraType.BACK :
                com.aliyun.svideosdk.common.struct.recorder.CameraType.FRONT);
        recorder.setCamera(mCameraType);
    ...
    private void setCameraType(com.aliyun.svideosdk.common.struct.recorder.CameraType mCameraType) {
        this.mCameraType = mCameraType;
        checkIsCameraFacingFront(this.mCameraType);
    }

    private void checkIsCameraFacingFront(com.aliyun.svideosdk.common.struct.recorder.CameraType cameraType) {
        mIsCameraFacingFront = false;
        if (Camera.getNumberOfCameras() > cameraType.getType()) {
            Camera.CameraInfo cameraInfo = new Camera.CameraInfo();
            Camera.getCameraInfo(cameraType.getType(), cameraInfo);
            if (cameraInfo.facing == Camera.CameraInfo.CAMERA_FACING_FRONT) {
                mIsCameraFacingFront = true;
            }
        }
    }
    ...
    private Integer mCameraRotation;
    private void initOrientationDetector() {
        ...
        orientationDetector.setOrientationChangedListener(new OrientationDetector.OrientationChangedListener() {
            ...
            public void onOrientationChanged() {
                ...
                if (mCameraRotation != null && rotation == mCameraRotation) {
                    return;
                }
